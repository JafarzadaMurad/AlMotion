...
import { MessageSquare, Settings2 as SettingsIcon } from 'lucide-react';
...
export const PropertiesSidebar = memo(function PropertiesSidebar() {
  ...
  return (
    <>
      {/* Right Sidebar */}
      <div
        className={`panel-bg border-l border-border shrink-0 relative h-full ${rightSidebarOpen ? '' : 'w-0'
          }`}
            ...
            >
              <div className="flex h-full min-w-0">
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 px-3 text-[10px] font-bold uppercase tracking-wider transition-colors border-r border-border",
                    rightSidebarTab === 'properties' ? "bg-background text-primary" : "bg-secondary/20 text-muted-foreground hover:bg-secondary/30"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 px-3 text-[10px] font-bold uppercase tracking-wider transition-colors border-r border-border",
                    rightSidebarTab === 'ai' ? "bg-background text-primary" : "bg-secondary/20 text-muted-foreground hover:bg-secondary/30"
                  )}
                >
              ...
              {rightSidebarTab === 'properties' && activeClipHeader && (
                <div className="flex-1 min-w-0 px-2 overflow-hidden border-r border-border h-full flex items-center">
                  <span className="truncate text-[10px] text-muted-foreground font-medium" title={activeClipHeader.title}>
              ...
              <div className="flex items-center px-2 gap-1">
                ...
                >
                  {propertiesFullColumn ? <ChevronUp className="w-3 h-3" /> : <ChevronDown className="w-3 h-3" />}
                </Button>
                <Button
                  variant="ghost"
                  size="icon"
